import { IWeatherListApiResponse } from '../interfaces/weather';
...
export const parseWeatherResponse = (weatherResponse: IWeatherListApiResponse): Promise<IWeatherListApiResponse> => {
...
const isInNextFiveDays = (dateStr: string): boolean => {
